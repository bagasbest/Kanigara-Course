...
class SahamAddCourse extends StatefulWidget {
  @override
  _SahamAddCourseState createState() => _SahamAddCourseState();
}

class _SahamAddCourseState extends State<SahamAddCourse> {
                  ...
                  child: RaisedButton(
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        DatabaseService.setCourseSaham(
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        backgroundColor: Constant.colorSecondary,
        content: Text(
          'Materi Saham berhasil diunggah',
