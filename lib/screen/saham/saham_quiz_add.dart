...
class SahamQuizAdd extends StatefulWidget {

  @override
  _SahamQuizAddState createState() => _SahamQuizAddState();
}

class _SahamQuizAddState extends State<SahamQuizAdd> {
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        backgroundColor: Constant.colorSecondary,
        content: Text(
          'Soal Quiz Saham Berhasil Ditambahkan',
