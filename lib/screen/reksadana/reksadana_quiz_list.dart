...
import 'package:kanigara_course/screen/reksadana/reksadana_quiz_edit.dart';

class ListOfQuizReksadana extends StatefulWidget {
  ...
  @override
  _ListOfQuizReksadanaState createState() => _ListOfQuizReksadanaState();
}

class _ListOfQuizReksadanaState extends State<ListOfQuizReksadana> {
  List choose = [
    null,
    null,
    null,
                ...
                RaisedButton(
                  onPressed: () {
                    ...
                    Route route = MaterialPageRoute(
                        builder: (context) => ReksadanaQuizEdit(
                          uid: uid,
                          question: question,
                          a: a,
                          b: b,
