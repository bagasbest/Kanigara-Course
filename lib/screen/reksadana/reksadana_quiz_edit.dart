...
class ReksadanaQuizEdit extends StatefulWidget {
  ...
  @override
  _ReksadanaQuizEditState createState() => _ReksadanaQuizEditState();
}

class _ReksadanaQuizEditState extends State<ReksadanaQuizEdit> {
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text("Perbarui Quiz Reksadana",
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        backgroundColor: Constant.colorSecondary,
        content: Text(
          'Soal Quiz Reksadana Berhasil Diperbarui',
