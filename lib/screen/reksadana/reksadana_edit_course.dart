...
class ReksadanaEditCourse extends StatefulWidget {
  final String uid;
  final String title;
  final String course;
  final String image;
  ...
  @override
  _ReksadanaEditCourseState createState() => _ReksadanaEditCourseState();
}

class _ReksadanaEditCourseState extends State<ReksadanaEditCourse> {
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text("Perbarui Materi Reksadana",
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        backgroundColor: Constant.colorSecondary,
        content: Text(
          'Materi Reksadana berhasil diperbarui',
